...
import com.sx129.odyzeshops.service.image.IImageService;
...
public class ImageController {
    ...
    public ResponseEntity<ApiResponse> saveImages(@RequestParam List<MultipartFile> files,@RequestParam Long productId) {
        try {
            ...
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(new ApiResponse("Error occurred while saving images", e.getMessage()));
        }
    }
